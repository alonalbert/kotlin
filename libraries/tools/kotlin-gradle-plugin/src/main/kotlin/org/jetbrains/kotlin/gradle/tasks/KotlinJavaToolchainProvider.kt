...
abstract class KotlinJavaToolchainProvider @Inject constructor(
    ...
    final override val toolchain: KotlinJavaToolchain.JavaToolchainSetter get() = defaultJavaToolchainSetter
    
    companion object {
        internal val TOOLCHAIN_SUPPORTED_VERSION: GradleVersion = GradleVersion.version("6.7")
    }
    ...
    private class DefaultJavaToolchainSetter(
        ...
        private val javaToolchainService get() = extensions.getByType(JavaToolchainService::class.java)

        private val currentToolchainSpec
            get() = extensions
                ...
                ?: throw GradleException(
                    "Java toolchain spec is not available"
                )

        private val javaLauncher: Property<JavaLauncher> = objectsFactory
            .propertyWithConvention(
                javaToolchainService.launcherFor(currentToolchainSpec)
            )
